...
## Progress log
- 2026-07-23 (RUN #59): No backfill items done — processed 4 NEW PF issues from dds-41237 (PF_1838-07-05/07-12/07-19/07-26, Whole 95-98). Backfill queue UNCHANGED: 4 Pennsylvania Freeman (PF_1838-01-18/01-25/02-08/02-15) + 86 Pencil Pusher clippings still pending a 300dpi pass; 2 FJ tombstones still missing.
- 2026-07-22 (RUN #57, retry on a HEALTHY container, interactive): PROMOTE done (prod #55->#56). Source-PDF access was blocked at start (Drive download session-expired; device placeholders; device_bash down) until Michiko made the Pennsylvania Freeman folder available-offline, hydrating dds-41235. Processed the first 4 issues of dds-41235 = PF_1838-04-05/04-12/04-19/04-26 (spring-1838 Freeman, Whole 82-85, 16 pages) at 150dpi w/ OMP_THREAD_LIMIT=1 half-page splits — these are NEW issues, not backfill. Backfill queue UNCHANGED: 4 Pennsylvania Freeman (PF_1838-01-18/01-25/02-08/02-15) + 86 Pencil Pusher clippings still pending a 300dpi pass. Remaining in dds-41235: 9 issues (May 3 - Jun 28).
