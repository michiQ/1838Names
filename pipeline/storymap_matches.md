...
- **Charles Gardner** (storymap)  ↔  Charles Gardner (blog)
- **Daniel Fox** (storymap)  ↔  Fox, Daniel (winch), Daniel Fox (blog)
...
- **Jane Johnson** (storymap)  ↔  Johnson, Jane (winch), Johnson, Jane (ugrr), Jane Johnson (blog)
...
- **William Bell** (storymap)  ↔  Bell, William (census), Bell, William (coppin), William Bell (blog)
- **William Sammons** (storymap)  ↔  Sammons, William (census)
- **William Still** (storymap)  ↔  Still, William (winch), William Still (blog)
