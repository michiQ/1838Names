...
DB = os.environ.get("BM_DB", "/tmp/run21/black_metropolis.db")
OUT = "/tmp/run21/out/1838_black_metropolis_viewer.html"
TPL = "/sessions/wizardly-exciting-dijkstra/mnt/Newspapers/1838 Names Database/pipeline/viewer_template.html"
ORG_ALIASES = "/sessions/wizardly-exciting-dijkstra/mnt/Newspapers/1838 Names Database/pipeline/org_aliases.json"
...
try:
    urls = json.load(open("/sessions/wizardly-exciting-dijkstra/mnt/Newspapers/1838 Names Database/pipeline/issue_urls.json"))
except FileNotFoundError:
    urls = {}
...
PAGES_DIR = "/sessions/wizardly-exciting-dijkstra/mnt/Newspapers/1838 Names Database/pages"
