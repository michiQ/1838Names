...
DB = os.environ.get("BM_DB", "/tmp/run29/black_metropolis.db")
OUT = "/tmp/run29/out/1838_black_metropolis_viewer.html"
TPL = "/sessions/sleepy-loving-ride/mnt/Newspapers/1838 Names Database/pipeline/viewer_template.html"
ORG_ALIASES = "/sessions/sleepy-loving-ride/mnt/Newspapers/1838 Names Database/pipeline/org_aliases.json"
...
try:
    urls = json.load(open("/sessions/sleepy-loving-ride/mnt/Newspapers/1838 Names Database/pipeline/issue_urls.json"))
except FileNotFoundError:
    urls = {}
...
PAGES_DIR = "/sessions/sleepy-loving-ride/mnt/Newspapers/1838 Names Database/pages"
